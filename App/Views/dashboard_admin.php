...
<body class="bg-[#FAF6F0] text-[#5C4333] antialiased min-h-screen selection:bg-[#B56B45]/20">
    ...
    <main class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <!-- Stats Grid -->
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5">
        ...
        <section class="bg-white rounded-3xl border border-[#EFE5D9] p-6 sm:p-8 shadow-md space-y-6">
            ...
            <div id="exchange-rate-status" class="text-xs text-emerald-600 font-medium hidden transition-opacity duration-300"></div>
        </section>
        ...
        <section class="bg-white rounded-3xl border border-[#EFE5D9] p-6 sm:p-8 shadow-md space-y-6">
            ...
            <div id="schedule-overview-container">
        ...
        <section class="bg-white rounded-3xl border border-[#EFE5D9] p-6 sm:p-8 shadow-md space-y-6">
            ...
            <!-- Formulario de Trabajador (oculto por defecto) -->
            <div id="worker-form-container" class="hidden bg-[#FAF6F0]/50 rounded-2xl p-6 border border-[#EFE5D9]">
                            ...
                            <tbody class="divide-y divide-[#EFE5D9]/30">
                                <?php foreach ($hairstyles as $style): ?>
                                    <tr class="hover:bg-[#FAF6F0]/20 transition-colors">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-3"><img src="<?php echo htmlspecialchars($style['image_url']); ?>" alt="" class="size-10 rounded-lg object-cover border border-[#EFE5D9]">
                                                <div>
                                                    <div class="text-sm font-extrabold text-[#5C4333]"><?php echo htmlspecialchars($style['name']); ?></div>
                                                    <div class="text-xs text-[#5C4333]/40 line-clamp-1 max-w-[200px]"><?php echo htmlspecialchars($style['description']); ?></div>
                                                </div>
                                            </div>
                                        </td>
        ...
        <section class="bg-white rounded-3xl border border-[#EFE5D9] p-6 sm:p-8 shadow-md space-y-6">
            ...
            <?php if (empty($reservations)): ?>
                <p class="text-sm text-[#5C4333]/50 text-center py-8">No hay reservas en el sistema.</p>
            <?php else: ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-[#EFE5D9]/40">
                            ...
                            <?php foreach ($reservations as $res): ?>
                                <tr class="hover:bg-[#FAF6F0]/20 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-extrabold text-[#5C4333]"><?php echo htmlspecialchars($res['username']); ?></div>
                                        <div class="text-xs text-[#5C4333]/50"><?php echo htmlspecialchars($res['email']); ?></div>
                                    </td>
